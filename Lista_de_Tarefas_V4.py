...
#Remover o produto
        ...
        if Pergunta_Removedora_Categorica.lower() in ("p", "pendente"):
            ...
            if 0 <= Pergunta_Removedora_Pendente < len(Lista_Pendente):#essa porra vai verificar se o numero for negativo ou maior q o numero da lista
        ...
        #Se a pessoa quiser remover a Concluida
            ...
            if 0 <= Pergunta_Removedora_Concluida < len(Lista_Concluida):#essa porra vai verificar se o numero for negativo ou maior q o numero da lista
...
#Avaliar se foi concluida ou Não
        ...
        if 0 <= Pergunta_Avaliadora < len(Lista_Pendente):
